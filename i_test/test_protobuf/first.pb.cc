...
static void InitDefaultsscc_info_helloworld_first_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_helloworld_first_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_helloworld_first_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_first_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_first_2eproto = nullptr;
...
const char descriptor_table_protodef_first_2eproto[] =
  "\n\013first.proto\022\002lm\"2\n\nhelloworld\022\n\n\002id\030\001 "
  "\001(\005\022\013\n\003str\030\002 \001(\t\022\013\n\003opt\030\003 \001(\005b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_first_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_first_2eproto_sccs[1] = {
  &scc_info_helloworld_first_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_first_2eproto_once;
static bool descriptor_table_first_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_first_2eproto = {
  &descriptor_table_first_2eproto_initialized, descriptor_table_protodef_first_2eproto, "first.proto", 77,
  &descriptor_table_first_2eproto_once, descriptor_table_first_2eproto_sccs, descriptor_table_first_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_first_2eproto::offsets,
  file_level_metadata_first_2eproto, 1, file_level_enum_descriptors_first_2eproto, file_level_service_descriptors_first_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_first_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_first_2eproto), true);
namespace lm {
...
void helloworld::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_helloworld_first_2eproto.base);
  str_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_str(), ptr, ctx, "lm.helloworld.str");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 opt = 3;
